...
let enviromentVariables = {
  ...
  APPLICATION_ENV: {
    message:
      "Please specify the value for e.g. local/development/qa/production",
    optional: false,
  },
  MONGODB_URL: {
  ...
  USER_DELETE_TOPIC: {
    message: "Required user delete kafka topic to consume user delete event",
    optional: false,
  },
  ID: {
    message: "Required Service Id for communication with other services",
    optional: false,
  },
  TELEMETRY_TOPIC: {
...
async function getKid() {
  if (process.env.PROJECT_CERTIFICATE_ON_OFF === "ON") {
    ...
    if (!kidData.success) {
      ...
      if (
        process.env.CERTIFICATE_ISSUER_KID &&
        process.env.CERTIFICATE_ISSUER_KID != ""
      ) {
